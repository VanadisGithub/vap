...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        genesisTransaction = new Transaction(coinbase.publicKey, walletA.publicKey, 10f, null);
        ...
        block1.addTransaction(walletA.sendFunds(walletB.publicKey, 4f));
        addBlock(block1);
        System.out.println("WalletA's balance is: " + walletA.getBalance());
...
//        System.out.println(JSONObject.toJSONString(newBlock));
    }
